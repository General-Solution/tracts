...
class PhaseTypeDistribution:
    ...
    generated by one (PhTMonoecious) or two (PhTDioecious) matrices.
    The PhaseTypeDistribution class includes the functions that transform the PhTMonoecious and PhTDioecious
    objects into probability function representations (CDF, density, histogram).
    """
...
class PhTMonoecious(PhaseTypeDistribution):
    ...
    Attributes
    ----------
    sex_specific_admixture : bool
        Whether admixture is sex-specific. In this model, the value is set to False.
...
class PhTDioecious(PhaseTypeDistribution):
    ...
    ----------
    sex_specific_admixture : bool
        Whether admixture is sex-specific. In both DF and DC models, the value is set to True.
    X_chr : bool
    ...
    def __init__(self, migration_matrix_f, migration_matrix_m, rho_f, rho_m, X_chromosome=False, X_chromosome_male=False, sex_model='DC',

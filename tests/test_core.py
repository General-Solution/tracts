...
def test_PDT_general(migration_matrix_A):
    PTD = tracts.PhT_Monoecious(migration_matrix_A)
...
class ModelComparison:
    ...
    def __init__(self, migration_matrix):
        ...
        self.PTD = tracts.phase_type_distribution.PhT_Monoecious(migration_matrix)
...
def compare_models_2(migration_matrix, Ls, population_number):
    ...
    PTD = tracts.phase_type_distribution.PhT_Monoecious(migration_matrix)
